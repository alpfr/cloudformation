...
LOG_GROUP_NAME = os.getenv('LOG_GROUP_NAME', '/aws/lambda/')
SPLUNK_HEC_URL = os.getenv('SPLUNK_HEC_URL', 'https://162.138.206.43:8088/services/collector/event?auto_extract_timestamp=true')
SPLUNK_HEC_TOKEN = os.getenv('SPLUNK_HEC_TOKEN', '67892b54-ba53-4187-9ecb-8bf3dc54a2e9')
